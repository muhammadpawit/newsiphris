<!doctype html>
<html lang="en" data-sidebar="light" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('logo-label.svg') }}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('logo-label.svg') }}" alt="" height="17">
                                </span>
                            </a>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user" src="{{ session('google_avatar') ?? '' }}">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{ route('gate') }}"><i class="ri ri-apps-line fs-16 align-middle me-1"></i> <span class="align-middle">Menu Utama</span></a>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="#" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('logo-label.svg') }}" alt="" height="102">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('logo-label.svg') }}" alt="" height="87">
                    </span>
                </a>
                <!-- Light Logo-->
