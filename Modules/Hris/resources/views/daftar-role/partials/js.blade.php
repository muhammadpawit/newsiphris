...
$(function () {
    ...
    $('#form-module').on('submit', function(e) {
        ...
        let url = id ? "{{ route('hris.daftar-role.update', ':id') }}".replace(':id', id) : "{{ route('hris.daftar-role.store') }}";
    ...
    $('#btn-export-excel, #btn-export-pdf').on('click', function () {
        ...
        let baseUrl = isExcel ? "{{ route('hris.daftar-role.excel') }}" : "{{ route('hris.daftar-role.pdf') }}";
